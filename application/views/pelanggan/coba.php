            ...
            <tbody>
                <?php foreach ($data as $row) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="#" class="btn btn-info btn-sm btn-edit" data-id="<?= $row->id_pupuk; ?>" data-name="<?= $row->nama_pupuk; ?>" data-price="<?= $row->harga_pupuk; ?>" data-category_id="<?= $row->jumlah_pupuk; ?>">Edit</a>
                            <a href="#" class="btn btn-danger btn-sm btn-delete" data-id="<?= $row->id_pupuk; ?>">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
